...
const Footer = () => {
  ...
  return (
    <>
      <Slider />
      <div className="my-10 flex items-center justify-between px-5">
        <p className="cursor-pointer flex items-center justify-center font-big-regular text-3xl border border-primaryBorder w-[487px] h-[85px]">
          info@myst.webflow.io
        </p>
        <p className="cursor-pointer flex items-center justify-center font-big-regular text-3xl border border-primaryBorder w-[487px] h-[85px]">
          +399 123 456-78-90
        </p>
        <div className="flex items-center gap-1 border border-primaryBorder p-2">
          <img
            className="cursor-pointer py-3 px-6 border border-primaryBorder bg-[#090909]"
            src={facebook}
            alt=""
          />
          <img
